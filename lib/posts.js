...
// const chronicPainDirectory = path.join(process.cwd(), 'posts/chronic-pain')
const lowBackPainDirectory = path.join(process.cwd(), 'posts/low-back-pain')
...
// const chronicPainCategory = 'chronic-pain';
const lowBackPainCategory = 'low-back-pain';
...
export function getSortedPostsData() {
  ...
  const allPostsData = LowBackPainFilesData.concat(neckPainFilesData).concat(pelvicHealthFilesData).concat(azureFilesData);
...
export function getAllPostIds() {
  ...
  const fileNames = lowBackPainFileNames.concat(neckPainFileNames).concat(pelvicHealthFileNames).concat(azureFileNames);
