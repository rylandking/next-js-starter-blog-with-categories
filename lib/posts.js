...
export function getSortedPostsData() {
  ...
  const allPostsData = axwayFilesData.concat(azureFilesData).concat(cloudflareFilesData); 
...
export function getAllPostIds() {
  ...
  const fileNames = axwayFileNames.concat(azureFileNames).concat(cloudflareFileNames);
