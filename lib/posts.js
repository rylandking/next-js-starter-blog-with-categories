...
const azureDirectory = path.join(process.cwd(), 'azure')
...
=======
  const allPostsData = axwayFilesData.concat(lowBackPainFilesData).concat(neckPainFilesData).concat(pelvicHealthFilesData);
>>>>>>> 656fd04e9e6e813af776b1c20d128f78960359f9
